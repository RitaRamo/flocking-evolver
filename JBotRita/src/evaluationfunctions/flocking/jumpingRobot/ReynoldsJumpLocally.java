...
public class ReynoldsJumpLocally extends EvaluationFunction {
	...
	public ReynoldsJumpLocally(Arguments args) {
		super(args);
...
//		System.out.println("movemnt"+ (fitnessForMovement) );
//
//		System.out.println("movemnt"+ (fitnessForMovement/simulator.getTime()) );
		return fitnessForAlignment/simulator.getTime() + fitnessForCohesion/simulator.getTime()-numberCollisions/simulator.getTime()+fitnessForMovement/simulator.getTime() ;
	}
...
//		System.out.println("current avarage_MovementContribution"+ avarage_MovementContribution + "and before groups" + fitnessForMovement);
