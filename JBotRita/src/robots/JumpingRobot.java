...
public class JumpingRobot extends DifferentialDriveRobot {
	...
	@ArgumentsAnnotation(name="wantedTimeDelta", defaultValue = "0.1")
	...
	public JumpingRobot(Simulator simulator, Arguments args) {
		...
		wantedTimeDelta=args.getArgumentAsDoubleOrSetDefault("wantedTimeDelta", 0.1);
	...
	public boolean charging(){
		return statusOfJumping && hasNotStartedJumping;
	}
